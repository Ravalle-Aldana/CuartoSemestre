...
def main() :
    ...
    imagen_inicial_path = os.path.join ( ASSETS_PATH , 'images', 'start.jpg' )
    ...
    icon = pygame.image.load ( os.path.join (ASSETS_PATH , 'images', 'start.jpg') )
    pygame.display.set_icon ( icon )

    # Inicializar los fondos
    fondo2 = pygame.image.load ( os.path.join ( ASSETS_PATH , 'images', 'start.jpg' ) )
    fondo2 = pygame.transform.scale ( fondo2 , (SCREEN_WIDTH , SCREEN_HEIGHT) )

    fondo3 = pygame.image.load ( os.path.join ( ASSETS_PATH , 'images', 'start.jpg' )  )
